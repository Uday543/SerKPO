            ...
            <ul className="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul className="nav nav-second-level expand">
                        ...
                        <li><a href="icons.html">Assigning Asset to Customer</a></li>
                ...
                <li>
                    ...
                    <ul className="nav nav-second-level expand">
                        <li><a href="ecommerce_products_grid.html">Customer Location</a></li>
                        <li><a href="ecommerce_product_list.html">Technician Location</a></li>
                        <li><a href="ecommerce_product.html">Asset Location</a></li>
                        <li><a href="ecommerce_product_detail.html">Navigation to customer location</a></li>
                ...
                <li>
                    ...
                    <ul className="nav nav-second-level expand">
                        ...
                        <li><a href="ecommerce_product_list.html">Assigning Asset to Customer</a></li>
